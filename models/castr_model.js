...
let comments = {
        comment: function(table, cols, vals, cb) { //For loading all comments
            orm.comment("comments", function(res) {
                cb(res);
            });
        },
        updateOne: function (table, condition, cb) {
            orm.updateOne("comments", table, condition, function (res) {
                cb(res);
            });
        },
        delete: function (table, condition, cb) {
            orm.delete("comments", table, condition, function (res) {
                cb(res);
            });
        }
    };
